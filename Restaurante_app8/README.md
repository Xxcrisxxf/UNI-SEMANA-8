...
PRICIPIOS DE OCP, LSP, SRPA APLICADOS 

Principio de Responsabilidad Única (SRP): Cada componente tiene una única razón para cambiar. Los modelos solo validan y representan datos, el servicio Restaurante manipula exclusivamente las colecciones del negocio, y main.py se limita a la captura de datos con input() y la visualización de la interfaz.
...
INSTRUCCIONE DE EJECUCION SON : Ubicarse en el archivo main.py abrir la terminal y ejecutar en la terminal python main.py
